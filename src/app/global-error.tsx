...
export default function GlobalErrorPage({
  ...
  return (
    <html lang="en" className="h-full antialiased">
      <head>
        <title>Application error | Bonzai</title>
      </head>
      <body className="min-h-screen bg-surface text-on-surface font-body">
        <main className="relative isolate min-h-screen overflow-hidden bg-surface px-4 py-16 text-on-surface sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          <div
          ...
          <section
            className="mx-auto grid min-h-[calc(100vh-8rem)] max-w-360 items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16"
            ...
            <div className="bg-surface-container-low p-5 sm:p-8 lg:translate-y-8">
              <div className="bg-surface-container-lowest p-6 sm:p-10">
                ...
                <p className="mt-6 max-w-xl font-body text-base leading-8 text-secondary sm:text-lg sm:leading-9">
                  Something in the living archive could not be arranged. Try
                  again, or return to Bonzai while this specimen settles back
                  into place.
                </p>
